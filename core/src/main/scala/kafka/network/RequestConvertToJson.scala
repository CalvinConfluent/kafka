...
object RequestConvertToJson {
  def request(request: AbstractRequest): JsonNode = {
    request match {
      ...
      case req: DescribeTopicsRequest => DescribeTopicsRequestDataJsonConverter.write(req.data, request.version)
  ...
  def response(response: AbstractResponse, version: Short): JsonNode = {
    response match {
      ...
      case res: DescribeTopicsResponse => DescribeTopicsResponseDataJsonConverter.write(res.data, version)
